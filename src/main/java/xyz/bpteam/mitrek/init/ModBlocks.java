...
import xyz.bpteam.mitrek.common.blocks.LightBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> LIGHT_BLOCK = BLOCKS.register("light_block", () -> new LightBlock(Block.Properties.create(Material.GLASS)));
