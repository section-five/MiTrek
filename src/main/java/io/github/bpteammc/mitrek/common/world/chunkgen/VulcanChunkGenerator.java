...
*/
/*package io.github.bpteammc.mitrek.common.world.chunkgen;
...
public class VulcanChunkGenerator implements IChunkGenerator {
    private World world;
    ...
    public VulcanChunkGenerator(World world) {
                ...
                for (int height32 = 0; height32 < 32; ++height32) {
                    ...
                    for (int h = 0; h < 8; ++h) {
                        ...
                        for (int x = 0; x < 4; ++x) {
                            ...
                            for (int z = 0; z < 4; ++z) {
                                if (height < 2) {
                                    primer.setBlockState(x4 * 4 + x, height32 * 8 + h, z4 * 4 + z, ModBlocks.STARSHIP_HULL.getDefaultState());
